...
export const MASTERS: Master[] = [
  ...
  /* ── 박영옥 ── */
  {
    ...
    matchPrinciples: [2, 1],
    matchExplain:
      "**원칙 2(Forward EPS) + 원칙 1(거시)의 한국 토착 버전**. \"Forward EPS\"라는 용어는 안 쓰지만, *기업 IR을 직접 만나 향후 1~2년 매출·이익을 예측*하는 방식이 사실상 Forward EPS 추정. 우리 와이프 버전은 *증권사 컨센서스 수치*를 활용 — 박영옥은 그 수치를 *자기 발로 검증*하는 셈. *남편 없이 와이프가 따라하기는 어려운* 영역이 함정.",
    quotes: [
    ...
    wifeAction: [
      ...
      "사고 싶은 종목은 *3개월간 관찰 후* 매수 — 박영옥의 \"3년 공부\"를 *3개월 관찰*로 축소한 와이프 버전.",
    ],
    flashTerms: [
