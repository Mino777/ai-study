...
graph TD
    subgraph Bad_Practice ["❌ 위험한 아키텍처"]
        Client_App["📱 iOS/Web App <br/> (Secret Key 내장)"] -- "API Call" --> Malicious_User["👨‍💻 악의적 사용자 <br/> (Key 탈취)"]
...
flowchart TD
    ...
    subgraph Serverless_Backend ["☁️ Firebase Cloud Functions"]
        ...
        E -- "✅ Valid" --> F{Check Rate Limit <br/> (Firestore)};
    ...
    subgraph External_Services ["🌐 External/Managed Services"]
        ...
        Firestore["🗄️ Firestore <br/>(Rate Limit Data)"];
        SecretManager["🔐 Secret Manager <br/>(API Key)"];
    end
