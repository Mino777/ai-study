...
flowchart TD
    ...
    subgraph Reducer ["Reducer Layer - TCA"]
      ...
      Pure --> Effect[".run 반환 · 비동기 Effect 실행"]
    end
    ...
    URLS2 --> Check{"checkResponse · status code"}
    Check -->|401| Notif["NotificationCenter · unauthorizedDetected post"]
    Check -->|4xx/5xx| APIErr["APIError.server · (message, code)"]
    Check -->|200-299| Decode["JSONDecoder · ChatResponse"]
