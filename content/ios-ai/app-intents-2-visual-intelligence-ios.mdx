...
> 이 엔트리는 Blake Crosley의 [App Intents 2.0 In iOS 26: Visual Intelligence, Interactive Snippets, And Deferred Properties](https://blakecrosley.com/blog/app-intents-2-ios-26-additions)를 정독하고 핵심을 추출한 것이다.

여기서 다루는 `IntentValueQuery`, `SemanticContentDescriptor`, Interactive Snippets 등은 WWDC25에서 공개된 iOS 26 App Intents의 실제 API다. 원문은 이 API들을 묶어 App Intents의 진화 방향을 분석한다.
