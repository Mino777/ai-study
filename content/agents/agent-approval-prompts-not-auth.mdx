...
Blake Crosley는 단순한 승인 프롬프트가 높은 컨텍스트를 요구하는 결정을 낮은 컨텍스트의 클릭으로 압축하면서 4가지 핵심적인 실패를 유발한다고 지적합니다. 이는 단순한 UX 문제를 넘어 OWASP가 정의한 에이전트 보안 위협([ASI09, Human-Agent Trust Exploitation](https://owasp.org/www-project-top-10-for-large-language-model-applications/llm-a09-agentic-threats/))으로 이어질 수 있습니다.
...
---
이 엔트리는 Blake Crosley의 [AI Agent Approval Prompts Are Not Authorization](https://www.blakecrosley.com/blog/ai-agent-approval-prompts-are-not-authorization/)을 정독하고 핵심을 추출한 것이다. 글에서 인용한 OpenAI Agents SDK 문서, OWASP Agentic Top 10, 관련 논문 등의 외부 자료를 함께 참고하여 분석의 깊이를 더했다.
