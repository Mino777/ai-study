...
applicable_to: ["any"]
connections: []
description: "사용자의 '승인 프롬프트'가 에이전트의 실제 '권한 부여(Authorization)'와 다르다는 중요한 구분을 제시합니다. 이는 에이전트가 어떤 범위의 작업을 수행할 수 있는지 명확히 정의하고 통제하는 메커니즘이 필요함을 강조합니다. 에이전트의 오용을 방지하고 안전성을"
generated_by: gemini
quiz:
