...
> 이 엔트리는 Blake Crosley의 [Deep Research Agents Need Evidence Graphs](https://blakecrosley.com/blog/deep-research-agents-evidence-graphs)를 정독하고 핵심을 추출한 것이다.
...
const exampleGraph: EvidenceGraph = {
  nodes: [
    ...
    { id: 'evidence-1', type: 'Evidence', content: 'Argus reports gains when scaling parallel Searchers (see paper benchmarks).', metadata: { page_number: 1 } },
