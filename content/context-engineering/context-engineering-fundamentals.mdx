...
date: "2026-04-09"
tags: [context-engineering, context-window, token, system-prompt, grounding]
confidence: 2
connections: [prompt-engineering/structured-output, rag/vector-search-basics, harness-engineering/harness-engineering-overview]
status: complete
description: "LLM의 성능은 프롬프트만으로 결정되지 않는다. 어떤 맥락을 어떤 순서로 얼마나 넣느냐가 핵심. Context Engineering의 기초 개념."
type: entry
---
