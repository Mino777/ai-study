...
applicable_to: ["any"]
connections: [harness-engineering/spec-driven-development-for-ai-agents, agents/ai-agent-custom-skill-building, harness-engineering/claude-code-native-features-migration-guide]
