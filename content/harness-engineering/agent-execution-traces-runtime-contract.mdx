...
> 이 엔트리는 Blake Crosley의 블로그 글 [Agent Execution Traces Are the Runtime Contract](https://blakecrosley.com/blog/agent-execution-traces-runtime-contract)와 그가 인용한 세 논문(Shepherd, AI Workflow Store, WildClawBench)을 정독하고 핵심을 추출한 것이다.
