...
- [/promote-solution](/wiki/harness-engineering/compound-engineering-philosophy)의 N=3+ 코드 게이트 승격은 skillify의 **보수적 버전** — Garry Tan은 N=1에서도 `"skillify it"` 한 마디로 즉시 박제. 내 워크플로에 "즉시 박제" 트리거도 추가할지 고민.
