...
status: complete
description: "Garry Tan의 Skillify 글을 /ingest로 정리한 세션 당일, Step 8(check-resolvable)을 허브에 구현하고 자기 프로젝트 9개(허브 1 + 워커 6 + 추가 iOS 2)에 dogfood. 워커 6개가 100% dark 상태였다는 발견과 28개 dark skill을 0으로 만든 3시간 기록. 숫자 위주, 서사 최소."
type: entry
quiz:
