...
applicable_to: ["any"]
connections: [harness-engineering/claude-code-native-features-migration-guide, harness-engineering/compound-automation-slash-commands]
description: "AI 에이전트 오케스트레이션 및 툴 체인에 활용되는 '훅(Hooks)'에 대한 실용적인 튜토리얼입니다. 5가지 프로덕션 레벨 훅 구현 사례를 통해 에이전트의 동작을 제어하고 확장하는 방법을 설명합니다. 하네스 엔지니어링의 구체적인 구현 기법을 제공할 것으로 기대됩니다."
generated_by: gemini
quiz:
