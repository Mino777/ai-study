...
connections:
  ...
  - agents/tool-use
status: complete
description: "프롬프트도 컨텍스트도 아닌, 에이전트를 감싸는 시스템을 설계하라. 실밸개발자 유튜브 영상을 정리하며 배운 하네스의 5가지 레버와 '보고-잡고-되살리기' 실전 제어법."
type: entry
quiz:
...
실밸개발자 채널의 ["프롬프트 엔지니어링은 끝났습니다: 이제 '하네스'의 시대입니다"](https://www.youtube.com/watch?v=6gvnDSAcZww) 영상을 보면서 가장 강하게 박힌 한 줄이 있다.
...
- 원본 영상: [실밸개발자 — "프롬프트 엔지니어링은 끝났습니다: 이제 '하네스'의 시대입니다"](https://www.youtube.com/watch?v=6gvnDSAcZww)
- 보강 자료:
