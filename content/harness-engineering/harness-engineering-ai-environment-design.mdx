...
confidence: 1
connections: [harness-engineering/ai-agent-persona-engineering-review-diversity-quality-strate, harness-engineering/ai-agent-start-here, harness-engineering/ai-api-cost-tracking-pattern, harness-engineering/addy-osmani-agent-harness-engineering]
status: draft
