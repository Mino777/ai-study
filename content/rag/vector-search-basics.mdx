...
category: rag
date: "2026-04-13"
tags: [rag, vector-search, embeddings, knn, ann, hnsw, similarity, foundational]
confidence: 3
connections:
...
status: complete
description: "RAG의 retrieval 단계가 의존하는 벡터 검색의 기초. 임베딩 → 코사인 유사도 → k-NN → ANN(HNSW/IVF) 흐름을 한 페이지에 정리."
type: entry
---
